...
tmepic <- lapply(c("CD20percent", "CD3percent"), function(z){
  ggboxplot(ihcScore, x = "Group1", y = z, 
...
difaa <- batchWilcox_v(data = as.data.frame(propdat), 
                       group = "sampleType", variables = useN)
